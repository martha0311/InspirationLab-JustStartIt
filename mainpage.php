    ...
    <body>
        ...
        <div id="profiles"> 
            ...
            <p id="positionLabel">Positions:</p>
                ...
                <!-- position 1 -->
            <div id="position">
                <img src="#" height="35px" width="35px" align="center" id="positionPic1API">
                ...
                <!-- position 2 -->
            <div id="position">
                <img src="#" height="35px" width="35px" align="center" id="positionPic2API">
